  ...
  return (
    ...
    <div className="mx-auto max-w-7xl px-6 lg:px-8">
      <div className="mx-auto max-w-2xl lg:text-center">
        ...
        Full-Stack Developer with 2 years of experience building 13+ web applications. Proficient in JavaScript, TypeScript, and PHP. Skilled in Front-End technologies like React.js, Next.js, and Vue.js, and Back-End development with Express.js. Experienced in managing both NoSQL (MongoDB) and SQL databases
        </p>
      </div>
