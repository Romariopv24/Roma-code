      ...
      >
        ...
        <div className="fixed inset-y-0 right-0 z-50 w-full overflow-y-auto bg-black px-6 py-6 sm:max-w-sm sm:ring-1 sm:ring-gray-900/10">
          <div className="flex items-center justify-between">
            <a
              href="#"
              className="-m-1.5 p-1.5 flex flex-row align-center items-center gap-x-2.5 "
            >
              <Image
            ...
            <div className="-my-6 divide-y divide-gray-500/10">
              <div className="space-y-2 py-6">
                <a
                  ...
                  className="-mx-3 block rounded-lg px-3 py-2 text-base/7 font-semibold hover:bg-[#1a6bbf] hover:text-white"
                >
                  About Me
                </a>
                <a
              ...
              <div className="py-6">
                <a
                  href="#contact"
                  onClick={() => setMenuOpen(false)}
                  className="-mx-3 block rounded-lg px-3 py-2.5 text-base/7 font-semibold hover:bg-[#1a6bbf] hover:text-white"
                >
                  Contact Me
                </a>
              </div>
